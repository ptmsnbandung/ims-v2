...
@section('content')
<div class="space-y-6">
    <!-- Role Welcome Banner (Modern Clean Gradient) -->
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 p-6 sm:p-8 text-white shadow-lg shadow-blue-500/15">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-white/20 backdrop-blur-md border border-white/30 mb-3 text-white">
            ...
            <div class="flex items-center gap-3">
                <div class="px-4 py-2.5 rounded-xl bg-black/20 backdrop-blur-md border border-white/20 text-xs">
                    <span class="text-blue-200">Waktu Server:</span>
                    <span class="font-semibold text-white ml-1">{{ now()->format('d M Y, H:i') }} WIB</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @if($user->isTeknik() || $user->isDirektur())
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md hover:border-blue-300 transition">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded">Drafter</span>
                </div>
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md hover:border-blue-300 transition">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded">Pipeline</span>
                </div>
                <h3 class="text-base font-bold text-slate-900">Status Pengajuan</h3>
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md hover:border-blue-300 transition">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded">Log</span>
                </div>
                <h3 class="text-base font-bold text-slate-900">Riwayat Input Drafter</h3>
        ...
        @if($user->isNoc() || $user->isDirektur())
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md hover:border-indigo-300 transition">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded">Core Network</span>
                </div>
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md hover:border-indigo-300 transition">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded">Eksekusi</span>
                </div>
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md hover:border-amber-300 transition">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-bold text-slate-500 bg-slate-100 px-2 py-0.5 rounded">Suspend / Isolir</span>
                </div>
        ...
        @if($user->isFinance() || $user->isDirektur())
            ...
            <a href="{{ route('finance.billing-layanan') }}"
               class="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md hover:border-blue-400 transition group">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-bold text-blue-600 bg-blue-50 border border-blue-200 px-2.5 py-0.5 rounded-full">Bulanan</span>
                </div>
            ...
            <a href="{{ route('finance.billing-registrasi') }}"
               class="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md hover:border-amber-400 transition group">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-bold text-amber-600 bg-amber-50 border border-amber-200 px-2.5 py-0.5 rounded-full">Pasang Baru</span>
                </div>
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-bold text-emerald-600 bg-emerald-50 border border-emerald-200 px-2.5 py-0.5 rounded-full">Kas Masuk</span>
                </div>
    ...
    <div class="rounded-2xl border-2 border-dashed border-slate-300 bg-white/60 p-8 text-center">
        ...
        <h3 class="text-sm font-bold text-slate-700">Area Konten Sistem Informasi Manajemen</h3>
