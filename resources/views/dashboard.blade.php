...
<div class="space-y-6">
    <!-- Role Welcome Banner -->
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 text-white shadow-lg p-6 sm:p-8">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                <div class="inline-flex items-center gap-2 px-2.5 py-1 rounded-full text-xs font-semibold bg-white/20 text-white border border-white/30 mb-3">
                ...
                <p class="text-sm text-blue-100 mt-1 max-w-2xl">
                    {{ $user->role_description }} &middot; Akun: <strong class="text-white font-medium">{{ $user->username }}</strong>
                </p>
            </div>

            <div class="flex items-center gap-3">
                <div class="px-4 py-2.5 rounded-xl bg-white/10 border border-white/20 text-xs backdrop-blur-sm">
                    <span class="text-blue-100">Waktu Server:</span>
                    <span class="font-medium text-white ml-1">{{ now()->format('d M Y, H:i') }} WIB</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        @if($user->isTeknik() || $user->isDirektur())
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 hover:border-blue-300 hover:shadow-md transition shadow-sm">
                ...
                <h3 class="text-base font-semibold text-slate-900">Draft Registrasi Pelanggan</h3>
                <p class="text-xs text-slate-500 mt-1">Input data calon pelanggan baru, lokasi ODP/koordinat, dan paket internet.</p>
                <div class="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-blue-600 font-medium">
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 hover:border-blue-300 hover:shadow-md transition shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-semibold text-slate-600 bg-slate-100 px-2 py-0.5 rounded">Pipeline</span>
                </div>
                <h3 class="text-base font-semibold text-slate-900">Status Pengajuan</h3>
                <p class="text-xs text-slate-500 mt-1">Pantau status pendaftaran yang telah diajukan ke tim NOC untuk aktivasi.</p>
                <div class="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-blue-600 font-medium">
                    <span>Menunggu Desain Referensi</span>
                    <span>&rarr;</span>
                </div>
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 hover:border-blue-300 hover:shadow-md transition shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-[11px] font-semibold text-slate-600 bg-slate-100 px-2 py-0.5 rounded">Log</span>
                </div>
                <h3 class="text-base font-semibold text-slate-900">Riwayat Input Drafter</h3>
                <p class="text-xs text-slate-500 mt-1">Laporan data pelanggan yang berhasil didaftarkan oleh akun Anda.</p>
                <div class="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-blue-600 font-medium">
                    <span>Menunggu Desain Referensi</span>
                    <span>&rarr;</span>
                </div>
        ...
        @if($user->isNoc() || $user->isDirektur())
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 hover:border-indigo-300 hover:shadow-md transition shadow-sm">
                <div class="flex items-center justify-between mb-4">
                ...
                <h3 class="text-base font-semibold text-slate-900">Manajemen Router & OLT</h3>
                <p class="text-xs text-slate-500 mt-1">Monitoring status IP, ping router, traffic load, dan koneksi API RouterOS.</p>
                <div class="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-indigo-600 font-medium">
                    <span>Menunggu Desain Referensi</span>
                    <span>&rarr;</span>
                </div>
            </div>
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 hover:border-indigo-300 hover:shadow-md transition shadow-sm">
                ...
                <h3 class="text-base font-semibold text-slate-900">Antrean Aktivasi Pelanggan</h3>
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 hover:border-amber-300 hover:shadow-md transition shadow-sm">
                <div class="flex items-center justify-between mb-4">
                ...
                <h3 class="text-base font-semibold text-slate-900">Eksekusi Suspend & Terminasi</h3>
                <p class="text-xs text-slate-500 mt-1">Daftar permintaan isolir dari Finance untuk pelanggan yang jatuh tempo.</p>
                <div class="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-amber-600 font-medium">
                    <span>Menunggu Desain Referensi</span>
                    <span>&rarr;</span>
                </div>
            </div>
        ...
        @if($user->isFinance() || $user->isDirektur())
            ...
            <a href="{{ route('finance.billing-layanan') }}"
               class="p-5 rounded-2xl bg-white border border-slate-200/90 hover:border-blue-400 hover:shadow-md transition group shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-10 h-10 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 group-hover:scale-110 transition">
            ...
            <a href="{{ route('finance.billing-registrasi') }}"
               class="p-5 rounded-2xl bg-white border border-slate-200/90 hover:border-amber-400 hover:shadow-md transition group shadow-sm">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-10 h-10 rounded-xl bg-amber-50 border border-amber-100 flex items-center justify-center text-amber-600 group-hover:scale-110 transition">
                        <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
            ...
            <div class="p-5 rounded-2xl bg-white border border-slate-200/90 hover:border-emerald-300 shadow-sm">
                <div class="flex items-center justify-between mb-4">
    ...
    <div class="rounded-2xl border-2 border-dashed border-slate-300 bg-slate-100/60 p-8 text-center">
        <div class="mx-auto w-12 h-12 rounded-full bg-slate-200 flex items-center justify-center text-slate-500 mb-3">
            <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
            </svg>
        </div>
        <h3 class="text-sm font-semibold text-slate-700">Area Konten Siap untuk Tampilan Referensi</h3>
