...
<div class="space-y-6"
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <!-- 1. Total Registrasi -->
        <div class="p-4 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-xl shadow-black/5 flex items-center justify-between">
            <div>
                <span class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Total Registrasi</span>
                <div class="text-2xl font-black text-slate-900 dark:text-white mt-1">{{ number_format($kpis['total'] ?? 0) }}</div>
                <span class="text-[11px] text-slate-500 dark:text-slate-400">Total pendaftaran baru</span>
            </div>
            <div class="p-3 rounded-xl bg-indigo-50 text-indigo-600 border border-indigo-200 dark:bg-indigo-500/10 dark:text-indigo-400 dark:border-indigo-500/20">
        ...
        <div class="p-4 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-xl shadow-black/5 flex items-center justify-between">
            <div>
                <span class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Draft Registrasi</span>
                <div class="text-2xl font-black text-amber-600 dark:text-amber-400 mt-1">{{ number_format($kpis['draft'] ?? 0) }}</div>
                <span class="text-[11px] text-amber-700 dark:text-amber-400 font-medium">Belum di-publish</span>
            </div>
            <div class="p-3 rounded-xl bg-amber-50 text-amber-600 border border-amber-200 dark:bg-amber-500/10 dark:text-amber-400 dark:border-amber-500/20">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <div class="p-4 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-xl shadow-black/5 flex items-center justify-between">
            <div>
                <span class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Published</span>
                <div class="text-2xl font-black text-blue-600 dark:text-blue-400 mt-1">{{ number_format($kpis['published'] ?? 0) }}</div>
                <span class="text-[11px] text-blue-600 dark:text-blue-300 font-medium">Masuk ke Billing Layanan</span>
            </div>
            <div class="p-3 rounded-xl bg-blue-50 text-blue-600 border border-blue-200 dark:bg-blue-500/10 dark:text-blue-400 dark:border-blue-500/20">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <div class="p-4 rounded-2xl bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-xl shadow-black/5 flex items-center justify-between">
            <div>
                <span class="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Metode Pembayaran</span>
                <div class="text-lg font-black text-emerald-600 dark:text-emerald-400 mt-1 flex items-center gap-1.5">
                    ...
                    <span class="text-xs font-normal text-slate-500 dark:text-slate-400">Online /</span>
                    <span>{{ number_format($kpis['manual'] ?? 0) }}</span>
                    <span class="text-xs font-normal text-slate-500 dark:text-slate-400">Manual</span>
                </div>
                <span class="text-[11px] text-emerald-700 dark:text-emerald-400 font-medium">Midtrans &bull; Transfer &bull; Cash</span>
            </div>
            <div class="p-3 rounded-xl bg-emerald-50 text-emerald-600 border border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/20">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
