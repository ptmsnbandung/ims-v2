<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-[#F5F6FA] text-slate-800">
<head>
    <meta charset="utf-8">
...
<body class="h-full font-sans antialiased selection:bg-blue-600 selection:text-white bg-[#F5F6FA] text-slate-800"
      x-data="{ 
    ...
    <div class="min-h-full flex flex-col">
        ...
        <div class="flex-1 flex overflow-hidden">
                ...
                <nav class="ims-sidebar-nav flex-1 px-2.5 py-3 space-y-1.5 overflow-y-auto overflow-x-visible"
                    ...
                    <div class="ims-nav-wrapper ims-has-flyout"
                        ...
                        <button type="button"
                                ...
                                title="Infrastruktur">
                            <span class="flex items-center gap-3.5">
                                <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('noc.olt*', 'noc.gpon*', 'noc.odp*', 'noc.pop*', 'noc.wilayah*') ? 'text-white' : 'text-[#9CA3AF]' }}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                        ...
                        <div x-show="infraOpen"
                            ...
                            <a href="{{ route('noc.odp') }}" class="flex items-center gap-2.5 px-3 py-2 rounded-lg text-xs transition {{ request()->routeIs('noc.odp*') ? 'text-blue-400 font-semibold bg-blue-500/10' : 'text-[#9CA3AF] hover:text-white hover:bg-white/5' }}">
                                <span class="w-1.5 h-1.5 rounded-full border {{ request()->routeIs('noc.odp*') ? 'border-blue-400 bg-blue-400' : 'border-slate-600' }}"></span>
                    ...
                    <div class="ims-nav-wrapper">
                        <a href="{{ route('teknik.pelanggan') }}"
                           class="ims-nav-item {{ request()->routeIs('*pelanggan*') ? 'active' : '' }}"
                           title="Data Pelanggan">
                            <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('*pelanggan*') ? 'text-white' : 'text-slate-400' }}" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.765l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                            </svg>
                            <span class="ims-nav-text">Data Pelanggan</span>
                        </a>
            ...
            <div class="flex-1 flex flex-col min-w-0 overflow-y-auto">
                <!-- Top Navbar -->
                <header class="min-h-16 bg-white border-b border-[#E5E7EB] flex items-center justify-between px-4 sm:px-6 lg:px-8 sticky top-0 z-30 py-2 shadow-xs">
                    <div class="flex items-center gap-3">
                        ...
                        <button @click="toggleSidebar()" 
                                ...
                                class="p-2 text-[#6B7280] hover:text-[#1E293B] rounded-xl bg-transparent hover:bg-[#F3F4F6] border border-[#E5E7EB] transition flex items-center justify-center flex-shrink-0 cursor-pointer">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.2" stroke="currentColor">
                        ...
                        <div>
                            <h1 class="text-base font-semibold text-[#1E293B] leading-tight">@yield('page_title', 'Dashboard')</h1>
                            <p class="text-xs text-[#64748B] hidden sm:block">Internet Management System &middot; Portal</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 sm:gap-4">
                        ...
                        <div class="flex flex-col items-end gap-1"
                            ...
                            <!-- 1. Status Gateway -->
                            <div class="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[#F8FAFC] border border-[#E2E8F0] text-[11px]">
                                <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                                <span class="text-[#64748B]">Status Gateway: <strong class="text-emerald-600 font-semibold">Online</strong></span>
                            </div>

                            <!-- 2. Jam Realtime WIB -->
                            <div class="flex items-center gap-1 text-[11px] text-[#64748B] font-medium tracking-wide">
                                <svg class="w-3 h-3 text-[#2563EB] flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                </svg>
                                <span class="font-mono text-[#1E293B] font-bold" x-text="timeWib">--:--:-- WIB</span>
                                <span class="text-[10px] text-[#94A3B8] hidden sm:inline" x-text="'&middot; ' + dateWib"></span>
                            </div>
                        </div>
                        ...
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open"
                                    class="flex items-center gap-2.5 p-1.5 rounded-xl hover:bg-slate-100/80 border border-transparent hover:border-[#E2E8F0] transition cursor-pointer">
                                <div class="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#3B82F6] to-[#4F46E5] flex items-center justify-center font-bold text-xs text-white flex-shrink-0 shadow-xs">
                                    {{ substr(auth()->user()->nama, 0, 1) }}
                                </div>
                                <div class="text-left hidden md:block">
                                    <span class="block text-xs font-semibold text-[#1E293B] leading-tight">{{ auth()->user()->nama }}</span>
                                    <span class="block text-[10px] text-[#2563EB] font-medium">{{ auth()->user()->nama_level }}</span>
                                </div>
                                <svg class="w-4 h-4 text-[#64748B]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                                </svg>
                            </button>
                            ...
                            <div x-show="open"
                                 ...
                                 class="absolute right-0 mt-2 w-56 rounded-xl bg-white border border-[#E2E8F0] shadow-xl shadow-slate-300/40 py-1.5 z-50">
                                <div class="px-4 py-2 border-b border-[#E2E8F0] text-xs">
                                    <p class="font-semibold text-[#1E293B]">{{ auth()->user()->nama }}</p>
                                    <p class="text-[#64748B] truncate">{{ auth()->user()->username }}</p>
                                </div>
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit" class="w-full text-left px-4 py-2 text-xs text-[#BE123C] hover:bg-[#FFF1F2] flex items-center gap-2 cursor-pointer transition">
