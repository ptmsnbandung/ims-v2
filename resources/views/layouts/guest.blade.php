...
<body class="h-full font-sans text-slate-800 antialiased selection:bg-blue-600 selection:text-white bg-slate-50">
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="pointer-events-none absolute -bottom-40 left-1/3 w-96 h-96 bg-sky-100 rounded-full blur-3xl opacity-70"></div>

        <div class="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
            <!-- Brand Logo / Header -->
            <div class="flex flex-col items-center">
                <div class="w-16 h-16 rounded-2xl bg-white border border-slate-200 p-2 shadow-lg shadow-blue-500/5 mb-4 flex items-center justify-center">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-xl relative z-10 px-4">
            <div class="bg-white border border-slate-200 shadow-xl shadow-slate-200/50 rounded-2xl p-6 sm:p-8">
                @yield('content')
            </div>
