...
<body class="h-full font-sans text-slate-800 antialiased selection:bg-blue-600 selection:text-white bg-[#F5F6FA]">
    <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="pointer-events-none absolute -bottom-40 left-1/3 w-96 h-96 bg-blue-600/5 rounded-full blur-3xl"></div>

        <div class="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
            <!-- Brand Logo / Header -->
            <div class="flex flex-col items-center">
                <div class="w-16 h-16 rounded-2xl bg-white border border-[#E2E8F0] p-2 shadow-lg shadow-slate-200/60 mb-4 flex items-center justify-center">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="IMS Logo" class="w-full h-full object-contain">
                </div>
                <h2 class="text-2xl font-bold tracking-tight text-[#1E293B] flex items-center gap-2">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-xl relative z-10 px-4">
            <div class="bg-white border border-[#E2E8F0] shadow-xl shadow-slate-200/80 rounded-2xl p-6 sm:p-8">
                @yield('content')
            </div>
