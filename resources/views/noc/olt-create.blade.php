    ...
    <form action="{{ route('noc.olt.store') }}" method="POST" class="space-y-6">
            ...
            <div class="pt-6 border-t border-slate-200 space-y-4" x-data="{ expanded: true }">
                ...
                <div x-show="expanded" class="space-y-4 pt-2">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <!-- Password -->
                        <div class="space-y-1">
                            <label class="block text-[11px] font-bold text-slate-400">Password Login</label>
                            <input type="password" 
                                   name="password" 
                                   x-model="password"
                                   placeholder="••••••••" 
        ...
        <div class="flex flex-wrap items-center gap-3">
            ...
            <a href="{{ route('noc.olt') }}" 
               class="px-5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-200 text-slate-300 text-xs font-bold transition">
                Cancel
            </a>
        </div>
    </form>
