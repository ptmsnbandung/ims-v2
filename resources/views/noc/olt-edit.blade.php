...
<div class="space-y-6"
    ...
    <div class="flex items-center gap-2 text-xs font-semibold text-slate-500 dark:text-slate-400">
        ...
        <span>&gt;</span>
        <span class="text-slate-900 dark:text-white">Edit: {{ $olt->name_olt ?? $olt->kode_olt }}</span>
    </div>
            ...
            <div class="pt-6 border-t border-slate-200 dark:border-slate-800 space-y-4" x-data="{ expanded: true }">
                ...
                <div x-show="expanded" class="space-y-4 pt-2">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <!-- Password -->
                        <div class="space-y-1">
                            <label class="block text-[11px] font-bold text-slate-700 dark:text-slate-400">Password Baru</label>
                            <input type="password" 
                                   name="password" 
                                   x-model="password"
