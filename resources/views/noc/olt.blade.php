...
<div class="space-y-6"
    ...
    <!-- =================================================================== -->
    <!-- 2. TABLE MASTER DATA OLT (DARK COMMAND CENTER THEME)                -->
    <!-- =================================================================== -->
                        ...
                        <tr class="hover:bg-slate-50/80 transition">
                            ...
                            <td class="py-4 px-5">
                                <div class="flex items-center gap-2.5">
                                    <div class="w-8 h-8 rounded-xl bg-blue-500/10 border border-blue-500/20 text-blue-400 flex items-center justify-center flex-shrink-0 shadow-sm">
                            ...
                            <!-- 3. POP Server -->
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-semibold bg-slate-800 text-slate-200 border border-slate-200 shadow-sm">
                            ...
                            <!-- 4. IP Address -->
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-mono font-bold bg-blue-500/10 text-blue-400 border border-blue-500/20 shadow-sm">
                            ...
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 shadow-sm">
                                    <svg class="w-3 h-3 text-emerald-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" />
                                    </svg>
                            ...
                            <!-- 6. Status PON Aktif -->
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-amber-500/10 text-amber-400 border border-amber-500/20 shadow-sm">
                            ...
                            <td class="py-4 px-5 text-right">
                                <div class="inline-flex items-center gap-1.5">
                                    ...
                                    <a href="{{ route('noc.gpon', ['olt' => $olt->kode_olt]) }}" 
                                       class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-[11px] font-bold shadow-md shadow-blue-500/20 transition">
                                    ...
                                    <a href="{{ route('noc.olt.edit', $olt->kode_olt) }}" 
                                       class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-amber-600 hover:bg-amber-500 text-white text-[11px] font-bold shadow-md shadow-amber-500/20 transition">
                                        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                    ...
                                    <button type="button" 
                                            ...
                                            class="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-rose-600 hover:bg-rose-500 text-white text-[11px] font-bold shadow-md shadow-rose-500/20 transition cursor-pointer">
                                        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                        ...
                        <tr>
                            <td colspan="7" class="py-12 text-center text-slate-400 text-xs">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <span class="font-bold text-slate-300">Tidak ada data OLT ditemukan.</span>
    ...
    <div x-show="deleteModalOpen" 
        ...
        <div class="bg-white border border-slate-200 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 text-slate-100"
            ...
            <div class="flex items-center gap-3 text-rose-500">
                ...
                <div>
                    <h3 class="font-bold text-white text-sm">Hapus Perangkat OLT?</h3>
                    <p class="text-xs text-slate-400">Tindakan ini tidak dapat dibatalkan.</p>
                </div>
            </div>

            <p class="text-xs text-slate-300">
                Apakah Anda yakin ingin menghapus data OLT <span class="font-bold text-white" x-text="oltToDelete?.name"></span> (<span class="font-mono text-blue-400 font-bold" x-text="oltToDelete?.kode"></span>)?
            </p>
            ...
            <form :action="deleteActionUrl" method="POST" class="flex items-center justify-end gap-2.5 pt-2">
                ...
                <button type="button" 
                        ...
                        class="px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-200 text-slate-300 text-xs font-bold transition">
                    Batal
                </button>
                <button type="submit" 
