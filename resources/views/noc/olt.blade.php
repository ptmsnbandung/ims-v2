...
<div class="space-y-6"
    ...
    @if(session('success'))
        <div class="flex items-center gap-3 p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-semibold shadow-lg shadow-emerald-500/5">
    ...
    @if(session('error'))
        <div class="flex items-center gap-3 p-4 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-rose-400 text-xs font-semibold shadow-lg shadow-rose-500/5">
    ...
    <!-- =================================================================== -->
    <div class="bg-white border border-slate-200 rounded-2xl shadow-xl shadow-black/5 overflow-hidden text-slate-900">
        
        <!-- Search Bar Top Right -->
        <div class="p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center sm:justify-end gap-3 border-b border-slate-200 bg-white">
        ...
        <div class="overflow-x-auto bg-white">
            <table class="w-full text-left text-xs border-collapse">
                <thead>
                    <tr class="bg-[#0b192e] text-slate-100 text-[11px] font-bold uppercase tracking-wider border-b border-slate-800">
                ...
                <tbody class="divide-y divide-slate-200 bg-white text-slate-900 font-sans">
                    @forelse($olts as $olt)
                        @php
                            ...
                            $kodeDisplay = !empty($olt->kode_olt) ? $olt->kode_olt : ($olt->hostname ?? 'OLT-MSN');
                        @endphp
                        <tr class="hover:bg-slate-50 transition">
                            <!-- 1. Kode OLT -->
                            <td class="py-4 px-5">
                                <div class="flex items-center gap-2.5">
                                    <div class="w-7 h-7 rounded-lg bg-blue-50 border border-blue-200 text-blue-600 flex items-center justify-center flex-shrink-0">
                            ...
                            <!-- 3. POP Server -->
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-semibold bg-[#1e293b] text-white border border-slate-700 shadow-sm">
                                    <svg class="w-3 h-3 text-slate-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            ...
                            <!-- 4. IP Address -->
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-mono font-bold bg-blue-50 text-blue-700 border border-blue-200 shadow-sm">
                                    <svg class="w-3 h-3 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            ...
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-emerald-50 text-emerald-700 border border-emerald-300 shadow-sm">
                                    <svg class="w-3 h-3 text-emerald-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" />
                                    </svg>
                            ...
                            <!-- 6. Status PON Aktif -->
                            <td class="py-4 px-5">
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold bg-amber-50 text-amber-800 border border-amber-300 shadow-sm">
                                    <svg class="w-3 h-3 text-amber-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                    </svg>
                        ...
                        <tr>
                            <td colspan="7" class="py-12 text-center text-slate-400 text-xs">
                                <div class="flex flex-col items-center justify-center">
                                    <svg class="w-10 h-10 text-slate-300 mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 14.25h13.5m-13.5 0a3 3 0 0 1-3-3m3 3a3 3 0 1 0 0 6h13.5a3 3 0 1 0 0-6" />
                                    </svg>
                                    <span class="font-bold text-slate-700">Tidak ada data OLT ditemukan.</span>
        ...
        <div class="px-5 py-4 border-t border-slate-200 bg-white flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-xs text-slate-600 font-medium">
            <div>
    ...
    <div x-show="deleteModalOpen" 
        ...
        <div class="bg-white border border-slate-200 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 text-slate-900"
            ...
            <div class="flex items-center gap-3 text-rose-600">
                ...
                <div>
                    <h3 class="font-bold text-slate-900 text-sm">Hapus Perangkat OLT?</h3>
                    <p class="text-xs text-slate-500">Tindakan ini tidak dapat dibatalkan.</p>
                </div>
            </div>

            <p class="text-xs text-slate-600">
                Apakah Anda yakin ingin menghapus data OLT <span class="font-bold text-slate-900" x-text="oltToDelete?.name"></span> (<span class="font-mono text-blue-600 font-bold" x-text="oltToDelete?.kode"></span>)?
            </p>
