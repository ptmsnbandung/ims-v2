                            ...
                            <td class="py-4 px-4 align-top text-center text-xs">
                                <div class="flex items-center justify-center gap-1.5">
                                    <a href="{{ route('teknik.dokumen.langganan', $item->nomor_internet) }}?download=pdf" 
                                       target="_blank"
                                       class="p-1.5 rounded-lg bg-slate-800 hover:bg-emerald-950/80 text-emerald-400 hover:text-emerald-300 border border-transparent hover:border-emerald-500/30 transition" 
                                    ...
                                    <a href="{{ route('teknik.dokumen.langganan', $item->nomor_internet) }}" 
                                       target="_blank"
                                       class="p-1.5 rounded-lg bg-slate-800 hover:bg-sky-950/80 text-sky-400 hover:text-sky-300 border border-transparent hover:border-sky-500/30 transition" 
                                    ...
                                    <a href="{{ route('teknik.pelanggan.profile', $item->nomor_internet) }}" 
                                       class="p-1.5 rounded-lg bg-slate-800 hover:bg-blue-950/80 text-blue-400 hover:text-blue-300 border border-transparent hover:border-blue-500/30 transition" 
