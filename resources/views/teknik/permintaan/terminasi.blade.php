                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/40 transition">
                            ...
                            <td class="py-4 px-4 align-top">
                                ...
                                <a href="{{ route('teknik.pelanggan.profile', $item->nomor_internet) }}" 
                                   class="font-mono font-bold text-blue-600 dark:text-blue-400 hover:underline tracking-wide text-xs block mt-0.5"
        ...
        <div @click.away="scheduleModalOpen = false"
            ...
            <form :action="'{{ url('/noc/terminasi') }}/' + modalKodeTrx + '/schedule'" method="POST" class="flex flex-col flex-1 overflow-hidden">
                ...
                <div class="p-5 space-y-4 overflow-y-auto flex-1">
                    ...
                    <!-- 1. Schedule Collect (Date Input) -->
                    <div>
                        <label class="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">
                            Schedule Collect <span class="text-rose-500 font-bold">*</span>
                        </label>
                        <input type="date" 
                               name="date_schedule" 
                               required 
                    ...
                    <!-- 2. Team Teknisi Checklist Box (Clean & Scrollable) -->
                    <div>
