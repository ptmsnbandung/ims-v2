...
<div class="space-y-5"
        ...
        <form method="GET" action="{{ route('teknik.tiket.gangguan') }}" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-3 items-center">
            ...
            @else
                ...
                <div class="lg:col-span-3">
                    <select name="kategori" class="w-full text-xs px-3.5 py-2.5 rounded-xl bg-white border border-slate-300 text-slate-900 font-semibold focus:outline-none focus:ring-2 focus:ring-cyan-500 shadow-xs">
            ...
            <div class="{{ request('kategori') ? 'lg:col-span-4' : 'lg:col-span-3' }}">
                <input type="text" 
                       ...
                       class="w-full text-xs px-3.5 py-2.5 rounded-xl bg-white border border-slate-300 text-slate-900 placeholder-slate-400 font-medium focus:outline-none focus:ring-2 focus:ring-cyan-500 shadow-xs">
            </div>
            ...
            <div class="{{ request('kategori') ? 'lg:col-span-3' : 'lg:col-span-2' }}">
                <input type="text" 
                       ...
                       class="w-full text-xs px-3.5 py-2.5 rounded-xl bg-white border border-slate-300 text-slate-900 placeholder-slate-400 uppercase font-semibold focus:outline-none focus:ring-2 focus:ring-cyan-500 shadow-xs">
            </div>

            <!-- 4. Dropdown Semua Status -->
            <div class="{{ request('kategori') ? 'lg:col-span-2' : 'lg:col-span-2' }}">
                <select name="status" class="w-full text-xs px-3.5 py-2.5 rounded-xl bg-white border border-slate-300 text-slate-900 font-semibold focus:outline-none focus:ring-2 focus:ring-cyan-500 shadow-xs">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <a href="{{ route('teknik.tiket.gangguan', array_merge(request()->except('page'), ['status' => '11'])) }}" 
           class="p-3.5 rounded-xl bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white font-bold text-xs shadow-md shadow-rose-500/20 transition flex items-center justify-between cursor-pointer group {{ request('status') === '11' ? 'ring-2 ring-slate-800 scale-[1.02]' : '' }}">
        ...
        <a href="{{ route('teknik.tiket.gangguan', array_merge(request()->except('page'), ['status' => '12'])) }}" 
           class="p-3.5 rounded-xl bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-slate-900 font-bold text-xs shadow-md shadow-amber-500/20 transition flex items-center justify-between cursor-pointer group {{ request('status') === '12' ? 'ring-2 ring-slate-800 scale-[1.02]' : '' }}">
        ...
        <a href="{{ route('teknik.tiket.gangguan', array_merge(request()->except('page'), ['status' => '13'])) }}" 
           class="p-3.5 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold text-xs shadow-md shadow-emerald-500/20 transition flex items-center justify-between cursor-pointer group {{ request('status') === '13' ? 'ring-2 ring-slate-800 scale-[1.02]' : '' }}">
        ...
        <a href="{{ route('teknik.tiket.gangguan', array_merge(request()->except('page'), ['status' => '14'])) }}" 
           class="p-3.5 rounded-xl bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 text-white font-bold text-xs shadow-md shadow-slate-600/20 transition flex items-center justify-between cursor-pointer group {{ request('status') === '14' ? 'ring-2 ring-slate-800 scale-[1.02]' : '' }}">
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        ...
        <div class="px-5 py-3.5 border-b border-slate-200 flex items-center justify-between text-xs text-slate-500 bg-slate-50">
            <div>
                Show <span class="font-bold text-slate-900">10</span> entries
            </div>
            <div class="font-mono">
                Total: <strong class="text-slate-900">{{ $tikets->total() }}</strong> Tiket
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-xs border-collapse">
                <thead>
                    <tr class="border-b border-slate-200 bg-slate-100 text-[11px] font-extrabold text-slate-800 uppercase tracking-wider">
                        @if(request('kategori') === 'ubah_password')
                        ...
                        <tr class="hover:bg-slate-50 transition">
                            ...
                            @if(request('kategori') === 'ubah_password')
                                ...
                                <td class="py-4 px-4 align-top">
                                    ...
                                    <div class="text-[11px] text-slate-500 mt-0.5 font-sans">
                                        {{ $dateCreateFormatted }}
                                    </div>
                                </td>
                                ...
                                <td class="py-4 px-4 align-top">
                                    <div class="font-bold text-slate-900 uppercase text-xs">
                                        @if($nomorInternet && $nomorInternet !== '-')
                                            <a href="{{ route('teknik.pelanggan.profile', $nomorInternet) }}" 
                                               class="font-mono text-cyan-700 hover:text-cyan-800 hover:underline mr-1 font-bold"
                                    ...
                                    <div class="text-[11px] text-slate-600 mt-1 uppercase leading-relaxed font-sans">
                                        {{ $alamat }}
                                    </div>
                                </td>
                                ...
                                <td class="py-4 px-4 align-top text-[11px] space-y-1">
                                    <div class="text-slate-800">
                                        <span class="text-slate-500 font-semibold">User :</span> <strong class="font-mono text-cyan-700">{{ $userPppoe }}</strong> 
                                        <span class="text-slate-500 font-semibold ml-1.5">Pass :</span> <strong class="font-mono text-amber-700">{{ $passPppoe }}</strong>
                                    </div>
                                    <div class="text-slate-700">
                                        <span class="text-slate-500 font-semibold">MediaAkses :</span> <strong>{{ $mediaAkses }}</strong>
                                    </div>
                                    <div class="text-slate-700">
                                        <span class="text-slate-500 font-semibold">POP :</span> {{ $popName }}
                                    </div>
                                </td>
                                ...
                                <td class="py-4 px-4 align-top text-[11px] space-y-1">
                                    <div>
                                        <span class="text-slate-500 font-semibold">Password Lama :</span>
                                        <div class="font-mono text-slate-900 font-semibold mt-0.5">{{ $passLama }}</div>
                                    </div>
                                    <div class="pt-1">
                                        <span class="text-slate-500 font-semibold">password Baru :</span>
                                        <div class="font-semibold text-slate-900 mt-0.5 leading-relaxed">{{ $passBaru }}</div>
                                    </div>
                                </td>
                                ...
                                <td class="py-4 px-4 align-top">
                                    <div class="flex flex-col gap-1">
                                        <div class="font-extrabold text-xs uppercase {{ $statusVal === '11' ? 'text-amber-600' : ($statusVal === '12' ? 'text-blue-600' : ($statusVal === '13' || $statusVal === 'Selesai' ? 'text-emerald-600' : 'text-slate-600')) }}">
                                        ...
                                        <div class="pt-1.5 flex items-center gap-1.5">
                                            <button type="button"
                                                    ...
                                                    class="p-1.5 rounded-lg bg-cyan-50 hover:bg-cyan-600 text-cyan-700 hover:text-white transition cursor-pointer border border-cyan-200"
                                            ...
                                            @if(auth()->user()?->hasRole(['teknik', 'noc', 'direktur', 'admin']))
                                                @if($statusVal === '11')
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            class="p-1.5 rounded-lg bg-amber-50 hover:bg-amber-500 text-amber-700 hover:text-white transition cursor-pointer border border-amber-200"
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            class="p-1.5 rounded-lg bg-rose-50 hover:bg-rose-600 text-rose-700 hover:text-white transition cursor-pointer border border-rose-200"
                                                            title="Batalkan (KD14)">
                                                        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
                                                            <path stroke-linecap="round" stroke-linejoin="round" d="m9.75 9.75 4.5 4.5m0-4.5-4.5 4.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                                        </svg>
                                                ...
                                                @elseif($statusVal === '12')
                                                    ...
                                                    <button type="button"
                                                            ...
                                                            class="p-1.5 rounded-lg bg-emerald-50 hover:bg-emerald-600 text-emerald-700 hover:text-white transition cursor-pointer border border-emerald-200"
                            ...
                            @else
                                ...
                                <td class="py-3.5 px-4">
                                    ...
                                    <div class="text-[11px] font-mono mt-0.5">
                                        @if($nomorInternet && $nomorInternet !== '-')
                                            <a href="{{ route('teknik.pelanggan.profile', $nomorInternet) }}" 
                                               class="text-cyan-700 hover:text-cyan-800 hover:underline font-bold"
                                               title="Buka Profile Pelanggan">
                                                {{ $nomorInternet }}
                                            </a>
                                        @else
                                ...
                                <td class="py-3.5 px-4 text-slate-700 font-medium">
                                    ...
                                    @if(!empty($item->nama_pop))
                                        <div class="mt-1 text-[10px] inline-flex items-center gap-1 px-2 py-0.5 rounded bg-slate-100 text-slate-700 font-semibold">
                                ...
                                <td class="py-3.5 px-4">
                                    @if(($item->kat_tiket ?? null) == '12')
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-[11px] font-bold bg-rose-50 text-rose-700 border border-rose-200">
                                    ...
                                    @elseif(($item->kat_tiket ?? null) == '13')
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-[11px] font-bold bg-purple-50 text-purple-700 border border-purple-200">
                                            <svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                                            </svg>
                                    ...
                                    @else
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-[11px] font-bold bg-cyan-50 text-cyan-800 border border-cyan-200">
                                            <svg class="w-3 h-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                    ...
                                    @if(!empty($item->prioritas) && $item->prioritas !== 'Normal')
                                        <div class="mt-1">
                                            <span class="text-[9px] px-1.5 py-0.5 rounded bg-amber-100 text-amber-800 font-extrabold">
                                ...
                                <!-- Keluhan / Catatan -->
                                <td class="py-3.5 px-4">
                                    <div class="text-xs text-slate-800 font-medium line-clamp-2">
                                        {{ $item->keluhan ?? '-' }}
                                    </div>
                                    @if(!empty($item->solusi) || !empty($item->penanganan))
                                        <div class="mt-1 text-[11px] text-emerald-700 font-bold line-clamp-1">
                                            Solusi: {{ $item->solusi ?? $item->penanganan }}
                                        </div>
                                    @endif
                                    @if(!empty($item->team_teknisi))
                                        <div class="mt-0.5 text-[10px] text-slate-600 font-semibold">
                        ...
                        <tr>
                            <td colspan="6" class="py-12 text-center text-slate-500 font-medium">
                                <div class="flex flex-col items-center justify-center gap-2">
                                    ...
                                    <span class="font-semibold text-slate-700">No data available in table</span>
        ...
        <!-- Pagination Bar -->
        <div class="px-5 py-4 border-t border-slate-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-xs text-slate-500 bg-slate-50">
            <div>
    ...
    <div x-show="detailModalOpen"
        ...
        <div class="bg-white border border-slate-200 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl p-6 text-slate-900 space-y-4"
             @click.away="detailModalOpen = false">
            <div class="flex items-center justify-between pb-3 border-b border-slate-200">
                <h3 class="text-base font-extrabold text-slate-900 flex items-center gap-2">
                    <svg class="w-5 h-5 text-cyan-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
                    </svg>
                    <span>Detail Tiket Pengaduan</span>
                </h3>
                <button type="button" @click="detailModalOpen = false" class="text-slate-400 hover:text-slate-700 text-2xl font-bold cursor-pointer">&times;</button>
            </div>

            <div class="space-y-3 text-xs">
                <div class="grid grid-cols-3 gap-2 py-1.5 border-b border-slate-100">
                    <span class="text-slate-500 font-semibold">ID / Kode Tiket:</span>
                    <span class="col-span-2 font-mono font-extrabold text-cyan-700" x-text="modalKodeTiket"></span>
                </div>
                <div class="grid grid-cols-3 gap-2 py-1.5 border-b border-slate-100">
                    <span class="text-slate-500 font-semibold">Nomor Internet:</span>
                ...
                <div class="grid grid-cols-3 gap-2 py-1.5 border-b border-slate-100">
                    ...
                    <span class="col-span-2 font-bold text-slate-900 uppercase" x-text="modalNamaPelanggan"></span>
                </div>
                <div class="grid grid-cols-3 gap-2 py-1.5 border-b border-slate-100">
                    <span class="text-slate-500 font-semibold">Kategori Tiket:</span>
                    <span class="col-span-2 font-bold text-indigo-700" x-text="modalKatTiket"></span>
                </div>
                <div class="grid grid-cols-3 gap-2 py-1.5 border-b border-slate-100">
                    <span class="text-slate-500 font-semibold">Keluhan / Pesan:</span>
                    <span class="col-span-2 text-slate-800 font-medium" x-text="modalKeluhan"></span>
                </div>
                <template x-if="modalSolusi">
                    <div class="grid grid-cols-3 gap-2 py-1.5 border-b border-slate-100">
                        <span class="text-slate-500 font-semibold">Solusi / Penanganan:</span>
                        <span class="col-span-2 text-emerald-700 font-bold" x-text="modalSolusi"></span>
                    </div>
                </template>
                <template x-if="modalTeamTeknisi">
                    <div class="grid grid-cols-3 gap-2 py-1.5 border-b border-slate-100">
                        <span class="text-slate-500 font-semibold">Tim Teknisi:</span>
                        <span class="col-span-2 text-amber-700 font-bold" x-text="modalTeamTeknisi"></span>
                    </div>
                </template>
            </div>

            <div class="pt-3 border-t border-slate-200 flex items-center justify-between gap-2">
                <button type="button" @click="detailModalOpen = false" class="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold transition cursor-pointer">
                    Tutup
                </button>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <template x-if="modalStatus === '11' || modalStatus === '12'">
                            <button type="button"
                                    ...
                                    class="px-3.5 py-2 rounded-xl bg-rose-50 hover:bg-rose-600 text-rose-700 hover:text-white border border-rose-200 text-xs font-bold transition cursor-pointer">
                                Batalkan (KD14)
                            </button>
                        </template>
                    </div>
    ...
    <div x-show="scheduleModalOpen"
        ...
        <div class="bg-white border border-slate-200 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl p-6 text-slate-900 space-y-4"
            ...
            <div class="flex items-center justify-between pb-3 border-b border-slate-200">
                ...
                <button type="button" @click="scheduleModalOpen = false" class="text-slate-400 hover:text-slate-700 text-2xl font-bold cursor-pointer">&times;</button>
            </div>
            ...
            <form :action="'{{ url('/teknik/tiket/gangguan') }}/' + modalId + '/schedule'" method="POST" class="space-y-4 text-xs">
                ...
                <div class="p-3.5 bg-slate-50 border border-slate-200 rounded-xl space-y-1">
                    <div class="flex justify-between">
                        ...
                        <strong class="text-slate-900 uppercase" x-text="modalNamaPelanggan"></strong>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-slate-500 font-semibold">Nomor Internet:</span>
                        <strong class="font-mono text-cyan-700 font-bold" x-text="modalNomorInternet"></strong>
                    </div>
                </div>

                <div>
                    <label class="block text-slate-800 font-bold mb-1">Tanggal Jadwal Penanganan:<span class="text-rose-600 font-bold">*</span></label>
                    <input type="date" name="date_schedule" x-model="modalDateSchedule" class="w-full text-xs px-3.5 py-2.5 rounded-xl bg-white border border-slate-300 text-slate-900 font-semibold focus:outline-none focus:ring-2 focus:ring-cyan-500 shadow-xs" required>
                </div>

                <div>
                    <label class="block text-slate-800 font-bold mb-1">Waktu Penanganan:<span class="text-rose-600 font-bold">*</span></label>
                    <input type="text" name="time_schedule" x-model="modalTimeSchedule" placeholder="Contoh: 09:00 - 12:00 WIB" class="w-full text-xs px-3.5 py-2.5 rounded-xl bg-white border border-slate-300 text-slate-900 font-semibold focus:outline-none focus:ring-2 focus:ring-cyan-500 shadow-xs" required>
                </div>

                <div>
                    <label class="block text-slate-800 font-bold mb-1">Tim Teknisi / Personil:</label>
                    <input type="text" name="team_teknisi" x-model="modalTeamTeknisi" placeholder="Nama Teknisi / Tim yang ditugaskan" class="w-full text-xs px-3.5 py-2.5 rounded-xl bg-white border border-slate-300 text-slate-900 font-semibold focus:outline-none focus:ring-2 focus:ring-cyan-500 shadow-xs">
                </div>

                <div>
                    <label class="block text-slate-800 font-bold mb-1">Catatan / Detail Keluhan Tambahan:</label>
                    <textarea name="keluhan" x-model="modalKeluhan" rows="2" class="w-full text-xs px-3.5 py-2.5 rounded-xl bg-white border border-slate-300 text-slate-900 font-medium focus:outline-none focus:ring-2 focus:ring-cyan-500 shadow-xs"></textarea>
                </div>

                <div class="pt-2 flex justify-end gap-2">
                    <button type="button" @click="scheduleModalOpen = false" class="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold cursor-pointer">
                        Batal
                    </button>
                    <button type="submit" class="px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-bold shadow-lg shadow-amber-500/20 cursor-pointer">
                        Simpan Jadwal (KD12)
                    </button>
                </div>
            </form>
    ...
    <div x-show="resolveModalOpen"
        ...
        <div class="bg-white border border-slate-200 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl p-6 text-slate-900 space-y-4"
            ...
            <div class="flex items-center justify-between pb-3 border-b border-slate-200">
                ...
                <button type="button" @click="resolveModalOpen = false" class="text-slate-400 hover:text-slate-700 text-2xl font-bold cursor-pointer">&times;</button>
            </div>
            ...
            <form :action="'{{ url('/teknik/tiket/gangguan') }}/' + modalId + '/resolve'" method="POST" class="space-y-4 text-xs">
                ...
                <div>
                    <label class="block text-slate-800 font-bold mb-1">Catatan Solusi / Tindakan Penyelesaian:<span class="text-rose-600 font-bold">*</span></label>
                    <textarea name="solusi" x-model="modalSolusi" rows="3" placeholder="Jelaskan tindakan teknis yang telah dilakukan..." class="w-full text-xs px-3.5 py-2.5 rounded-xl bg-white border border-slate-300 text-slate-900 font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500 shadow-xs" required></textarea>
                </div>
                ...
                <div class="p-3.5 bg-slate-50 border border-slate-200 rounded-xl space-y-2.5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                        <div>
                            <label class="block text-slate-700 text-[10px] font-bold mb-1">ODP Baru / Port:</label>
                            <input type="text" name="odp_baru" placeholder="Contoh: ODP-BBR-01 / Port 4" class="w-full text-xs px-3 py-2 rounded-lg bg-white border border-slate-300 text-slate-900 focus:ring-1 focus:ring-emerald-500 font-semibold shadow-xs">
                        </div>
                        <div>
                            <label class="block text-slate-700 text-[10px] font-bold mb-1">Redaman Rx (dBm):</label>
                            <input type="text" name="redaman" placeholder="Contoh: -18.50" class="w-full text-xs px-3 py-2 rounded-lg bg-white border border-slate-300 text-slate-900 focus:ring-1 focus:ring-emerald-500 font-semibold shadow-xs">
                        </div>
                        <div>
                            <label class="block text-slate-700 text-[10px] font-bold mb-1">Panjang Kabel Dropcore (Meter):</label>
                            <input type="number" name="panjang_kabel" placeholder="Contoh: 75" class="w-full text-xs px-3 py-2 rounded-lg bg-white border border-slate-300 text-slate-900 focus:ring-1 focus:ring-emerald-500 font-semibold shadow-xs">
                        </div>
                        <div>
                            <label class="block text-slate-700 text-[10px] font-bold mb-1">SN / MAC ONT:</label>
                            <input type="text" name="sn_ont" placeholder="Contoh: ZTEGC1234567" class="w-full text-xs px-3 py-2 rounded-lg bg-white border border-slate-300 text-slate-900 focus:ring-1 focus:ring-emerald-500 font-mono font-bold shadow-xs">
                        </div>
                    </div>
                </div>

                <div class="pt-2 flex justify-end gap-2">
                    <button type="button" @click="resolveModalOpen = false" class="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold cursor-pointer">
                        Batal
                    </button>
                    <button type="submit" class="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold shadow-lg shadow-emerald-600/20 cursor-pointer">
    ...
    <div x-show="cancelModalOpen"
        ...
        <div class="bg-white border border-slate-200 rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl p-6 text-slate-900 space-y-4"
            ...
            <div class="flex items-center justify-between pb-3 border-b border-slate-200">
                ...
                <button type="button" @click="cancelModalOpen = false" class="text-slate-400 hover:text-slate-700 text-2xl font-bold cursor-pointer">&times;</button>
            </div>
            ...
            <form :action="'{{ url('/teknik/tiket/gangguan') }}/' + modalId + '/cancel'" method="POST" class="space-y-4 text-xs">
                ...
                <div>
                    <label class="block text-slate-800 font-bold mb-1">Alasan Pembatalan:<span class="text-rose-600 font-bold">*</span></label>
                    <textarea name="note_cancel" x-model="modalNoteCancel" rows="3" placeholder="Tuliskan alasan pembatalan tiket..." class="w-full text-xs px-3.5 py-2.5 rounded-xl bg-white border border-slate-300 text-slate-900 font-medium focus:outline-none focus:ring-2 focus:ring-rose-500 shadow-xs" required></textarea>
                </div>

                <div class="pt-2 flex justify-end gap-2">
                    <button type="button" @click="cancelModalOpen = false" class="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold cursor-pointer">
                        Batal
                    </button>
                    <button type="submit" class="px-4 py-2 rounded-xl bg-rose-600 hover:bg-rose-700 text-white font-bold shadow-lg shadow-rose-600/20 cursor-pointer">
                        Batalkan Tiket (KD14)
                    </button>
                </div>
            </form>
    ...
    <div x-show="createModalOpen"
        ...
        <div class="bg-white border border-slate-200 rounded-2xl w-full max-w-xl overflow-hidden shadow-2xl p-6 text-slate-900 space-y-5"
            ...
            <div class="flex items-center justify-between pb-3 border-b border-slate-200">
                ...
                <button type="button" @click="createModalOpen = false" class="text-slate-400 hover:text-slate-700 text-2xl font-bold cursor-pointer">
                    &times;
                </button>
            </div>
            ...
            <form action="{{ route('teknik.tiket.gangguan.store') }}" method="POST" class="space-y-5 text-xs">
                ...
                <div>
                    <label class="block text-slate-800 font-bold mb-2">
                        Pilih Kategori Tiket<span class="text-rose-600 font-bold">*</span>
                    </label>
                    <div class="grid grid-cols-3 gap-2">
                        <label class="p-2.5 rounded-xl border cursor-pointer transition flex flex-col items-center gap-1 text-center"
                               :class="createKatTiket === '11' ? 'bg-cyan-50 border-cyan-500 text-cyan-800 font-bold' : 'bg-slate-50 border-slate-300 text-slate-600'">
                            <input type="radio" name="kat_tiket" value="11" x-model="createKatTiket" class="hidden">
                            <span class="text-xs">🔧 Gangguan</span>
                        </label>
                        <label class="p-2.5 rounded-xl border cursor-pointer transition flex flex-col items-center gap-1 text-center"
                               :class="createKatTiket === '12' ? 'bg-rose-50 border-rose-500 text-rose-800 font-bold' : 'bg-slate-50 border-slate-300 text-slate-600'">
                            <input type="radio" name="kat_tiket" value="12" x-model="createKatTiket" class="hidden">
                            <span class="text-xs">🔑 Ganti Password</span>
                        </label>
                        <label class="p-2.5 rounded-xl border cursor-pointer transition flex flex-col items-center gap-1 text-center"
                               :class="createKatTiket === '13' ? 'bg-purple-50 border-purple-500 text-purple-800 font-bold' : 'bg-slate-50 border-slate-300 text-slate-600'">
                ...
                <div class="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-4">
                    ...
                    <div>
                        <label class="block text-slate-800 font-bold mb-1.5">
                            Nomor Internet<span class="text-rose-600 font-bold">*</span>
                        </label>
                        <div class="flex items-center gap-3">
                            <div class="flex-1">
                                <input type="text" 
                                       ...
                                       class="w-full text-xs px-3.5 py-2.5 rounded-lg bg-white border border-slate-300 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 font-medium shadow-xs" 
                                       required>
                            </div>
                            <button type="button" 
                                    @click="checkCustomer()"
                        ...
                        <template x-if="createCustomerData">
                            <div class="mt-2.5 p-3 rounded-lg bg-cyan-50 border border-cyan-200 text-[11px] text-cyan-900 space-y-1">
                                <div class="font-bold flex items-center gap-1.5">
                                    <svg class="w-4 h-4 text-cyan-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                    </svg>
                                ...
                                <div class="text-slate-700 font-medium" x-text="'Alamat Asal: ' + createCustomerData.alamat"></div>
                                <div class="text-[10px] text-slate-600 font-semibold" x-text="'POP: ' + (createCustomerData.nama_pop || '-') + ' | Media: ' + (createCustomerData.media_akses || 'FTTH')"></div>
                            </div>
                        </template>

                        <!-- Error alert -->
                        <template x-if="createError">
                            <div class="mt-2 text-rose-600 text-xs font-bold flex items-center gap-1">
                        ...
                        <div class="space-y-3.5 pt-1">
                            <div>
                                <label class="block text-slate-800 font-bold mb-1">
                                    Jenis Relokasi<span class="text-rose-600 font-bold">*</span>
                                </label>
                                <div class="grid grid-cols-2 gap-2">
                                    <label class="p-2 rounded-lg border text-center cursor-pointer text-xs"
                                           :class="createJenisRelokasi === 'Eksternal' ? 'bg-purple-50 border-purple-500 text-purple-800 font-bold' : 'bg-white border-slate-300 text-slate-600'">
                                    ...
                                    <label class="p-2 rounded-lg border text-center cursor-pointer text-xs"
                                           :class="createJenisRelokasi === 'Internal' ? 'bg-purple-50 border-purple-500 text-purple-800 font-bold' : 'bg-white border-slate-300 text-slate-600'">
                            ...
                            <div>
                                <label class="block text-slate-800 font-bold mb-1">
                                    Alamat Tujuan Baru<span class="text-rose-600 font-bold">*</span>
                                </label>
                                <textarea name="alamat_baru" 
                                          ...
                                          class="w-full text-xs p-3 rounded-lg bg-white border border-slate-300 text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-xs"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="text" 
                                           ...
                                           class="w-full text-xs px-3 py-2 rounded-lg bg-white border border-slate-300 text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-xs">
                                </div>
                                <div>
                                    <label class="block text-slate-800 font-bold mb-1">
                                        Keterangan Relokasi:
                    ...
                    <template x-if="createKatTiket !== '13'">
                        <div>
                            <label class="block text-slate-800 font-bold mb-1.5">
                                <span x-text="createKatTiket === '12' ? 'Perubahan Password' : 'Keluhan / Gangguan'"></span><span class="text-rose-600 font-bold">*</span>
                            </label>
                            <textarea name="perubahan" 
                                      x-model="createPerubahan" 
                                      rows="4" 
                                      class="w-full text-xs p-3 rounded-lg bg-white border border-slate-300 text-slate-900 font-mono font-medium focus:outline-none focus:ring-2 focus:ring-cyan-500 leading-relaxed shadow-xs" 
                                      :required="createKatTiket !== '13'"></textarea>
                        </div>
                    </template>
                ...
                <div class="pt-2 flex items-center justify-end gap-2.5">
                    ...
                    <button type="button" 
                            ...
                            class="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold text-xs transition cursor-pointer">
                        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5" stroke="currentColor">
